function [exp_clean,unique_conditions] = struct_pullConditions(exp,extract_conditions,define_columns)
% OBJECTIVE:
...
trials_include = sum(ismember(trTypes,extract_conditions),2) == sum(sum(ismember(trTypes,extract_conditions),1) > 0);
