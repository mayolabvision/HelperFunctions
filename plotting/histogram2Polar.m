classdef histogram2Polar < matlab.mixin.SetGet
    ...
    properties
        ...
        % Color of colormap
        mapColor = histogram2Polar.defMapColor

        % Color limits
        colLimits = histogram2Polar.defColLimits
    ...
    methods
        function self = histogram2Polar(theta, rho, BinWidth, varargin)
            ...
            ip.addParameter('mapColor',flip(self.defMapColor));
            ip.addParameter('colLimits',self.defColLimits);
            ...
            %%
            colormap(self.Parent, self.mapColor);
            self.drawColorbar;
            clim(self.colLimits)
